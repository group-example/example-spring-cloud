...
public class OraclePaginationPlugin extends PluginAdapter {
	...
	public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
		...
		pageStart.addAttribute(new Attribute("test", "pagination != null and pagination.begin >= 0"));
		...
		pageEnd.addAttribute(new Attribute("test", "pagination != null and pagination.begin >= 0"));
		pageEnd.addElement(new TextElement(
				"<![CDATA[ ) row_ ) where rownum_ > #{pagination.begin} and  rownum_ <= #{pagination.end} ]]>"));
