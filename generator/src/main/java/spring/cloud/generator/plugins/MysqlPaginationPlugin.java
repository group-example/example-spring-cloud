...
public class MysqlPaginationPlugin extends PluginAdapter {
	...
	private void addPagination(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String name) {
		...
		topLevelClass.addImportedType(new FullyQualifiedJavaType("spring.cloud.dao.generic.Pagination<T>"));
		CommentGenerator commentGenerator = context.getCommentGenerator();
		Field field = new Field();
		field.setVisibility(JavaVisibility.PROTECTED);
		field.setType(new FullyQualifiedJavaType("spring.cloud.dao.generic.Pagination"));
		field.setName(name);
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType("spring.cloud.dao.generic.Pagination"), name));
		method.addBodyLine("this." + name + "=" + name + ";");
		commentGenerator.addGeneralMethodComment(method, introspectedTable);
		topLevelClass.addMethod(method);
		method = new Method();
		method.setVisibility(JavaVisibility.PUBLIC);
		method.setReturnType(new FullyQualifiedJavaType("spring.cloud.dao.generic.Pagination"));
